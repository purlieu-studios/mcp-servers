...
class TaskGenerator:
    ...
    def generate_task_plan(
        self, description: str, template: str = "custom", constraints: dict[str, Any] | None = None
    ) -> dict[str, Any]:
    ...
    def refine_task_plan(
        self, original_plan: dict[str, Any], adjustments: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    def estimate_complexity(self, description: str) -> dict[str, Any]:
    ...
    def _split_task(
        self, tasks: list[dict[str, Any]], task_id: int, split_count: int
    ) -> list[dict[str, Any]]:
    ...
    def _get_complexity_level(self, total_loc: int, indicators: dict[str, bool]) -> str:
